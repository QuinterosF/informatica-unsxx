...
<body class="body-perfil">
    ...
    <header id="header-perfil">
        <center>
            <h1>Ingeniería Informática<br>Coordinador del Instituto de Investigación y<br>Desarrollo de Aplicaciones Informáticas (IIDAI)</h1>
        </center>
    </header>
    <div class="fila" id="coor_iidai">
