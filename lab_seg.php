    ...
    <div id="page-wrapper">
        ...
        <div class="wrapper style1">
            <div class="container">
                <header>
                    <center>
                        <h1>Ingeniería Informática<br>Laboratorio de "Seguridad Informática"</h1>
                    </center>
                </header>
                <div class="fila">
                    <!-- ESCUDO DE LA MENCION -->
                    <div class="col-8 col-12-mobile">
                        <i class="image featured"><img src="images/laboratorios/seg.jpg" alt="" /></i>
                    </div>
                        ...
                        <a href="lab_mov.php">
                            <div class="fila comunicado col-12 col-12-mobile">
                                <div class="col-6 container-img">
                                    <img src="images/laboratorios/mov.jpg" />
                                </div>
                                <div class="col-6">
                                    <h4>Computación Móvil</h4>
                                </div>
                            </div>
                        </a>
                        <a href="lab_hd.php">
